...
namespace DomicWeb.Areas.Admin.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        {
            _unitOfWork.OrderHeader.UpdateStatus(OrderVM.OrderHeader.Id, SD.StatusInProcces);
            _unitOfWork.Save();
        ...
        {                 
            ...
            switch(status)
            {
                case "pending":
                    ...
                    break;
                case "inprocess":
                    objOrderHeaders = objOrderHeaders.Where(u => u.OrderStatus == SD.StatusInProcces);
                    break;
                case "completed":
